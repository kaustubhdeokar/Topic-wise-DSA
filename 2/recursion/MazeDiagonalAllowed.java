...
public class PrintPathsInAMaze {
    ...
    public ArrayList<String> paths(int[][] matrix, String path, int row, int col, int targetRow, int targetCol) {
        ...
        list.addAll(paths(matrix, path + "V", row + 1, col, targetRow, targetCol));
        list.addAll(paths(matrix, path + "H", row, col + 1, targetRow, targetCol));
        list.addAll(paths(matrix, path + "D", row + 1, col + 1, targetRow, targetCol));
        return list;
    }
