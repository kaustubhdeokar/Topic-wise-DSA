package dp.problems;//again the core concept of dp.lcs.
//pallindromes are nothing but same string written front and back.
//here an extra step is to calculate the actual dp.lcs string and calculate deletions.
...
public class NumberOfDeletionsToMakeItPallindrome {
    ...
    public int longestPalinSubseq(String s){
        ...
        System.out.println("dp.lcs string:"+lcsString);
